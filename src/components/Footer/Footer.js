...
const Footer = () => {
  return (
    <div className="grid grid-cols-7 bg-veryDarkViolet relative top-28 p-20 gap-10 ">
      <div className="col-span-2 text-left ">
        <h3 className="text-3xl text-white font-bold">Shortly</h3>
      </div>
      <div className="col-span-1 flex flex-col text-Gray text-sm">
      ...
      <div className=" child:cursor-pointer col-span-2 inline-flex  space-x-4 justify-start ">
